        ...
        <div className="rounded-2xl border border-white/10 bg-[#1e241e] p-6">
          ...
          {isOwner ? (
            ...
            <div className="mt-4 flex flex-col gap-4 border-t border-white/10 pt-4">
              <div className="flex items-center justify-between">
                <span className="text-sm text-zinc-400">다녀왔어요</span>
              ...
              {restaurant.visited && (
                <div>
                  <p className="text-sm text-zinc-400">별점</p>
                  <p className="mt-1 text-lg text-orange-400">
                    {"★".repeat(restaurant.rating ?? 0)}
                    <span className="text-zinc-600">
                      {"☆".repeat(5 - (restaurant.rating ?? 0))}
                    </span>
                  </p>
                </div>
              )}
              {restaurant.memo && (
                <div>
                  <p className="text-sm text-zinc-400">메모</p>
                  <p className="mt-1 text-zinc-200">{restaurant.memo}</p>
                </div>
              )}
